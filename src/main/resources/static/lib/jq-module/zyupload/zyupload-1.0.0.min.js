        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '						<input id="fileImage" type="file" size="30" ' + multiple + ">";
                    html += "					</div>";
                    html += "				</div>";
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                var newStr = file.name.split("").reverse().join("");
                var type = newStr.split(".")[0].split("").reverse().join("");
                var fileImgSrc = "/lib/jq-module/zyupload/skins/images/fileType/";
                if (type == "rar") {
                ...
                if (file.type.indexOf("image") == 0) {
                    ...
                    html += '	<a style="height:' + para.itemHeight + ";width:" + para.itemWidth + ';" href="#" class="imgBox">';
                    html += '		<div class="uploadImg" style="width:' + imgWidth + 'px">';
                    html += '			<img id="uploadImage_' + file.index + '" class="upload_file" src="' + GWDTZ_BASE_URL + fileImgSrc + '" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "		</div>";
                    html += "	</a>";
                    html += '	<p id="uploadProgress_' + file.index + '" class="file_progress"></p>';
                    html += '	<p id="uploadFailure_' + file.index + '" class="file_failure">上传失败，请重试</p>';
