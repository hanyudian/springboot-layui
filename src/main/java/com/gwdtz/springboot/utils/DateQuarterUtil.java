 ...
 *
 * @className: DateQuarterUtil
 * @Description: TODO时间季度处理工具类
 * @date: 2019年2月22日 下午3:21:41
 */
@Component
public class DateQuarterUtil {
     ...
     * 季度划分
     */
    public static final String ONEQUARTER = "01-01,03-31";//一季度
    public static final String TWOQUARTER = "04-01,06-30";//二季度
    public static final String THREEQUARTER = "07-01,09-30";//三季度
    public static final String FOURQUARTER = "10-01,12-31";//四季度
    /**
     *
     * @param strDate
     * @return
     ...
     * @return
     */
    public static Date parseDateYYYY(String strDate, String pattern) {
        Date date = null;
        try {
            if (pattern == null) {
                pattern = "yyyy";
     ...
     * @param quarter
     *            季度数 1、2、3、4
     * @return String[] 该季度第一天和最后一天日期
     */
    public static String getFirstLastDayByQuarter(int quarter) {
        String seasonDate = "";
        switch (quarter) {
            case 1:
                seasonDate = ONEQUARTER;
                break;
            case 2:
                seasonDate = TWOQUARTER;
                break;
            case 3:
                seasonDate = THREEQUARTER;
                break;
            case 4:
                seasonDate = FOURQUARTER;
                break;
            default:
                break;
        }
